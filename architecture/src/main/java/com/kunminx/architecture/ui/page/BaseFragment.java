...
import com.kunminx.architecture.load.ILoading;
import com.kunminx.architecture.load.LoadingViewWithJson;


/**
 * Create by KunMinX at 19/7/11
 */
public abstract class BaseFragment extends BaseDataBindingFragment {
    ...
    private void registerLoading() {
        loadingView = new LoadingViewWithJson(getContext());
    }
